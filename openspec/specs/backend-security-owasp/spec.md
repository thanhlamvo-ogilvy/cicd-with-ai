...
Define OWASP-aligned security requirements for the backend, covering SQL injection prevention, input validation, secret management, and sensitive data protection.
