...
Automated quality gates for frontend code in the GitHub Actions CI workflow, ensuring ESLint, TypeScript, Vitest, and bundle size checks run on every PR to `main`.
