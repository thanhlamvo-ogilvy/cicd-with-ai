...
Define API design conventions for the backend, ensuring consistent endpoint patterns, status codes, error formats, and architectural layering across all backend routes.
