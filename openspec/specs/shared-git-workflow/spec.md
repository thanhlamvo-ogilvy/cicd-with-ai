...
Define Git workflow and commit message format standards shared across all workspaces, covering branch naming, PR rules, commit structure, and merge strategy.
