# Persona Activation Governance

> Deterministic governance rules for selecting and reconciling AI personas across workspace, shared-file, and review-only contexts.

## Purpose

Define deterministic persona activation governance so persona selection and conflict resolution remain predictable across single-workspace, mixed-scope, and review-only tasks.
